jQuery("#simulation")
  .on("click", ".s-411d9417-6d48-4752-9322-7bde49f9ab6d .click", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-Path_168")) {
      cases = [
        {
          "blocks": [
            {
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "target": [ "#s-411d9417-6d48-4752-9322-7bde49f9ab6d #s-Path_168 svg" ],
                    "attributes": {
                      "path-background-color": "#C14444"
                    }
                  },{
                    "effect": {
                      "type": "none",
              ...
              "actions": [
                {
                  ...
                  "parameter": {
                    "target": "screens/3e72697d-295c-42e6-8aca-97304b98ba19",
                    "transition": {
                      "type": "turn",
                      "duration": 500
                    }
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/c9cf19e2-6b91-463e-8ea4-a5290dc8f060",
                    "transition": {
                      "type": "turn",
                      "duration": 500
                    }
